...
namespace
{
UImage* AddSalesImage(UWidgetTree* Tree, UCanvasPanel* Canvas, const TCHAR* Name,
...
UTextBlock* AddSalesText(UWidgetTree* Tree, UCanvasPanel* Canvas, const TCHAR* Name,
...
void UBotanicusSalesDisplayOccupiedWidget::NativeOnInitialized()
{
	...
	if (WidgetTree && !WidgetTree->RootWidget)
	{
		...
		AddSalesImage(WidgetTree, Canvas, TEXT("PlantDecoration"),
		...
		AddSalesImage(WidgetTree, Canvas, TEXT("PriceBackground"),
		...
		AddSalesImage(WidgetTree, Canvas, TEXT("QualityIcon"),
